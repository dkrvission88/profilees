  ...
  <div className="container">
    <div className="row">
      ...
      <div className="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div className="contact-box__info">
          <a href="#" className="contact-box__info--title">dkrvission442@gmail.com</a>
      ...
      <div className="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div className="contact-box__info">
          ...
          <p className="contact-box__info--subtitle">Dheeroo Bhai, India</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div className="container">
      <div className="row py-4 text-center text-white">
        ...
        <div className="col-lg-7 col-md-6">
          ...
          <a href="https://github.com/dkrvission88"><i className="fab fa-github"></i></a>
          <a href="https://linkedin.com/in/dheeraj-kumar55"><i className="fab fa-linkedin"></i></a>
